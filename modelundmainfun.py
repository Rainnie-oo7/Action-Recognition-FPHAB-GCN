...
from load_all_skeletons import load_all_skeletons, load_data_from_skeleton_path, load_coos_from_coordinatesdata, load_labels_from_coordinatesdata1, load_labels_from_coordinatesdata
...
dataimdumb = load_data_from_skeleton_path(skeleton_paths, hotend_indexed_dict)
datacoo = load_coos_from_coordinatesdata(dataimdumb)
labelsss = load_labels_from_coordinatesdata1(dataimdumb)
labels = load_labels_from_coordinatesdata(labelsss)
...
class RecurrentGCN(torch.nn.Module):
    def __init__(self, node_features):
        ...
        self.linear = torch.nn.Linear(32, 21)
