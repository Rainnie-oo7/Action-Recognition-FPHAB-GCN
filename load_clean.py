...
def get_obj_transform(sample, obj_root):
    ...
    return trans_matrix
## C:\Users\Boris Grillborzer\PycharmProjects\PoseEstimation\First-PersonHandActionBenchmarkF-PHAB\Video_files\Subject_1\Subject_1\close_liquid_soap\1\color\color_0000.jpeg
## C:\\Users\\Boris Grillborzer\\PycharmProjects\\PoseEstimation\\First-PersonHandActionBenchmarkF-PHAB\\Video_files\\Subject_1\\open_liquid_soap\\1\\color\\color_0000.jpeg
# Display utilities
...
if __name__ == '__main__':
    ...
    if args.obj is not None:
        # Load object mesh
        object_infos = load_objects(obj_root, sample['object'])
